...
Estaca::Estaca(string nombre_objeto, string cuadrante) {
...
void Estaca::buscar_objeto(Lista& lista) {
    ...
    if(encontrado) cout << "Se encontro/encontraron " << total <<  " Estaca/as" << endl;
    else cout << "» No se encontro ninguna Estaca en el cuadrante " << "'" << cardinal << "'" << endl << endl;
    cout << "────────────────────────────────────────────────────────────" << endl;
}