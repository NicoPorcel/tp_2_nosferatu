...
Cruz::Cruz(string nombre_objeto, string cuadrante) {
...
void Cruz::buscar_objeto(Lista& lista) {
    ...
    if(encontrado) cout << "Se encontro/encontraron " << total <<  " Cruz" << endl;
    else cout << "» No se encontro ninguna Cruz en el cuadrante " << "'" << cardinal << "'" << endl << endl;
    cout << "────────────────────────────────────────────────────────────" << endl;
}